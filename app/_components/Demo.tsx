...
function Demo() {
  ...
  return (
    <section className="py-6 md:py-20 border-t" id="demo">
      <div className="container mx-auto px-6">
        ...
        >
          ...
          <h2 className="text-5xl md:text-7xl font-bold mb-6 leading-tight gap-2">
            <span className="text-slate-900">Try Demo</span>
          ...
          <p className="text-xl md:text-2xl text-slate-600 max-w-4xl mx-auto leading-relaxed">
            Trinity follows battle-tested financial principles that adapt to
        ...
        <div className="max-w-5xl mx-auto bg-gray-900 rounded-3xl p-8 border border-gray-700">
          <div className="flex justify-between items-center mb-6">
            <h3 className="text-2xl font-bold text-white">
              Sarah&lsquo;s Marketing Agency
            </h3>
              ...
              <div className="flex justify-between items-center">
                ...
                <div className="text-right">
                  ...
                  <div className="text-sm text-green-400">
                    {demoDay >= 14
                      ? "PAID"
                      : `Accumulating: £${Math.min(1400, demoDay * 100)}`}
                  </div>
                </div>
              </div>
